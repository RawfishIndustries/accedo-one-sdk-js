 ...
 * @param  {string} [config.useSharedSession] makes all client instances reuse the same session when truthy (useful in node environment, when using the consumer sessionKey isn't possible)
